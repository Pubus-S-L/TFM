...
export default function UserDetail() {
    ...
    async function setUp() {
        try {
            let response = await fetch(`https://pubus.onrender.com/api/v1/users/${userId}`, {
                method: "GET",
                headers: {
    ...
    async function setUpPapers() {
        try {
            let response = await fetch(`https://pubus.onrender.com/api/v1/papers/users/${userId}?search=${searchTerm}`, {
                method: "GET",
                headers: {
                    Accept: "application/json",
                    "Content-Type": "application/json",
    ...
    const handleCreateChat = async () => {
      try {
        const response = await fetch(`https://pubus.onrender.com/api/v1/chat/create/${userId}/${otherUserId}`, {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
          }
