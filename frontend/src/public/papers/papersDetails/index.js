...
export default function PaperDetail() {
    ...
    function downloadFile(fileId,fileName) {
        fetch(`https://pubus.onrender.com/api/v1/papers/${paperId}/download/${fileId}`, {
          method: "GET",
          headers: {
    ...
    async function setUp() {
        setIsLoading(true)
        try {
            let response = await fetch(`https://pubus.onrender.com/api/v1/papers/${paperId}`, {
                method: "GET",
                headers: {
                    Accept: "application/json",
    ...
    async function likePaper(){
        ...
        try {
            let response = await fetch(`https://pubus.onrender.com/api/v1/papers/${user.id}/like/${paperId}`, {
                method: "POST",
                headers: {
