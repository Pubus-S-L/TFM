...
export default function UserProfile() {
  ...
  async function setUpFavorite() {
    try {
      const response = await fetch(`https://pubus.onrender.com/api/v1/users/${userId}/favorite`, {
        headers: {
        },
      });
  ...
  async function setUpRecommended() {
    try {
      const response = await fetch(`https://pubus.onrender.com/api/v1/users/${userId}/recommended`, {
        headers: {
        },
      });
  ...
  const handleUploadAvatar = async (file) => {
    ...
    try {
      ...
      const response = await fetch(`https://pubus.onrender.com/api/v1/users/${user.id}/upload`, {
        method: "POST",
        body: formData,
      })
  ...
  const handleDeleteAvatar = async () => {
    try {
      const response = await fetch(`https://pubus.onrender.com/api/v1/users/${user.id}/delete`, {
        method: "DELETE",
      })
