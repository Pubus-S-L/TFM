...
<%--
pubus :: a Spring Framework demonstration
--%>
...
<head>
    ...
    <title>pubus :: a Spring Framework demonstration</title>

    <%-- CSS generated from LESS --%>
    <spring:url value="/resources/css/pubus.css" var="pubusCss"/>
    <link href="${pubusCss}" rel="stylesheet"/>
