...
INSERT INTO papers(id,title,authors,publication_year,type_id,abstract_content,notes,keywords,user_id) VALUES(2,'My thesis','Paco O., Pedro P.',2024,4,'A thesis about informatics', 'Use of complexity knowledge for the efficiency of code ', 'complexity, efficiency, code',2)
